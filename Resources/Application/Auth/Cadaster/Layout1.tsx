...
import Button, { Login, Register } from "Resources/Components/Button";


const LayoutCadaster = () => {
  return (
    ...
    <section className="margin-top-10">
      ...
      <Link className="d-block font-13" href={"/auth/login"}>Entrar</Link>
    </section>
  </form>
  )
}

export default LayoutCadaster